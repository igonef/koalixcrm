    ...
    <fo:page-sequence master-reference="simple">
      <fo:static-content flow-name="xsl-region-before" >
        ...
        <fo:block font-size="13pt"
              ...
              text-align="left"
              font-weight="bold">
        Отчет о прибылях и убытках <xsl:value-of select="organisationname"/>
       </fo:block>
      </fo:static-content>
    <fo:static-content flow-name="xsl-region-after" >
      ...
      <fo:flow flow-name="xsl-region-body">
       ...
       <fo:block font-size="9pt"
              font-family="BitstreamVeraSans"
              text-align="left"
              line-height="13pt" >Прибыль</fo:block>
       <fo:table table-layout="fixed" width="100%">
     ...
     <fo:table-header font-size="9pt" line-height="9pt" font-weight="bold" font-family="BitstreamVeraSans">
         ...
         <xsl:for-each select="Account[@accountType='E']">
          <xsl:sort select="AccountNumber" data-type="number"/>
             <fo:table-row keep-together="always">
                ...
                <fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" padding="2.5pt">
                   <fo:block  text-align="end" >
                      <xsl:value-of select="format-number(currentValue,'#.##0,00', 'european')"/> RUR
                   </fo:block>
                </fo:table-cell>
             </fo:table-row>
            </xsl:for-each>
       ...
       <fo:block font-size="9pt"
              ...
              text-align="left"
              line-height="13pt"
              padding-top="0.7cm">Убыток</fo:block>
       <fo:table table-layout="fixed" width="100%">
          <fo:table-column column-width="3cm"/>
          <fo:table-column column-width="11cm"/>
          <fo:table-column column-width="3cm"/>
       ...
       <fo:table table-layout="fixed" width="100%">
          ...
          <fo:table-body font-size="9pt"
             ...
             <fo:table-row keep-together="always">
                ...
                <fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" padding="2.5pt">
                   <fo:block  text-align="end" >
                      <xsl:value-of select="format-number(TotalProfitLoss,'#.##0,00', 'european')"/> RUR
                   </fo:block>
                </fo:table-cell>
             </fo:table-row>
          </fo:table-body>
