   ...
   <fo:table-row >
          ...
          <fo:table-cell>
            <fo:block font-size="7pt"
              ...
              text-align="left"
              font-weight="bold">
                <xsl:value-of select="substring(object[@model='crm.purchaseorder']/field[@name='dateofcreation'], 9, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(object[@model='crm.purchaseorder']/field[@name='dateofcreation'], 6, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(object[@model='crm.purchaseorder']/field[@name='dateofcreation'], 1, 4)"/></fo:block>
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
            <fo:block font-size="7pt"
            ...
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left">CO-<xsl:value-of select="object[@model='crm.purchaseorder']/field[@name='contract']"/></fo:block>
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
            <fo:block font-size="7pt"
        ...
        <fo:block font-size="15pt"
              ...
              font-weight="bold"
              margin-top="1cm">
        Счет на оплату в-<xsl:value-of select="object[@model='crm.purchaseorder']/@pk"/>
       </fo:block>
        <fo:block font-size="9pt"
              font-family="BitstreamVeraSans"
              color="black"
          ...
          <xsl:sort select="field[@name=positionNumber]" data-type="number"/>
             ...
             <fo:table-row keep-together="always" keep-with-previous="always">
              ...
              <fo:table-row keep-together="always" keep-with-previous="always">
                ...
                <fo:table-cell number-columns-spanned="2" border-color="black" border-style="solid" border-width="0.5pt" padding="2.5pt">
                   <fo:block  text-align="end" >
                      <xsl:choose>
                        <xsl:when test="object[@model='crm.purchaseorder']/field[@name='lastCalculatedPrice']/None">-</xsl:when>
                        <xsl:otherwise>
                        <xsl:value-of select="format-number(object[@model='crm.purchaseorder']/field[@name='lastCalculatedPrice'], '#.##0,00', 'european')"/><xsl:text> </xsl:text><xsl:value-of select="object[@model='crm.currency']/field[@name='shortName']"/>
                        </xsl:otherwise>
                      </xsl:choose>
                   </fo:block>
                </fo:table-cell>
             ...
             <fo:table-row keep-together="always" keep-with-previous="always">
                ...
                <fo:table-cell number-columns-spanned="2" border-color="black" border-style="solid" border-width="0.5pt" padding="2.5pt">
                   <fo:block  text-align="end" >
             <xsl:choose>
               <xsl:when test="object[@model='crm.purchaseorder']/field[@name='lastCalculatedTax']/None">-</xsl:when>
               <xsl:otherwise>
               <xsl:value-of select="format-number(object[@model='crm.purchaseorder']/field[@name='lastCalculatedTax'], '#.##0,00', 'european')"/><xsl:text> </xsl:text><xsl:value-of select="object[@model='crm.currency']/field[@name='shortName']"/>
               </xsl:otherwise>
             </xsl:choose>
                   </fo:block>
                </fo:table-cell>
             ...
             <xsl:choose>
               <xsl:when test="object[@model='crm.purchaseorder']/field[@name='lastCalculatedPrice']/None">-</xsl:when>
               <xsl:otherwise>
               <xsl:value-of select="format-number(object[@model='crm.purchaseorder']/field[@name='lastCalculatedPrice']+object[@model='crm.purchaseorder']/field[@name='lastCalculatedTax'], '#.##0,00', 'european')"/><xsl:text> </xsl:text><xsl:value-of select="object[@model='crm.currency']/field[@name='shortName']"/>
               </xsl:otherwise>
             </xsl:choose>
                   </fo:block>
                </fo:table-cell>
